...
<x-guest-layout >
    <x-authentication-card>
        <a href="{{url('/index')}}" class=" px-4 px-lg-5">
            <h2 class="m-0 text-primary" style="font-size: 70px; margin-left: 100px;"><i class="fa fa-car me-3 "></i>CarServ</h2>
        </a>
        
       <h2 style="font-size: 30px; margin-left:300px; ">Register</h2><br>
