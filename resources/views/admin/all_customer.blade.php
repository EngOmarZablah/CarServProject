...
<body>
    ...
    <div  class="col py-3">
        ...
        <div class="div_design" style=" border:solid;border-color: rgb(3, 9, 99); background-color: rgb(196, 14, 29) ">
                        <h1 class="font_size" style="text-align: center">All Customer</h1>
                            ...
                            <tbody >
                                @foreach ($customer as $customer )
                                    ...
                                    <tr >
                                        ...
                                        <td style="padding: 20px">{{$customer->phone}}</td>
                                        <td style="padding: 20px">{{$customer->address}}</td>
                                        <td style="padding: 20px">
                                              @php
                                                  echo $order=App\Models\Order::where('customer_id',$customer->id)->count();
                                              @endphp  
