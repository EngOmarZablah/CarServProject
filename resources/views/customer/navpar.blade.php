        ...
        <div class="collapse navbar-collapse"  id="navbarCollapse">
            <div  class="navbar-nav ms-auto p-4 p-lg-0">
               ...
               @php
                ...
                $order=App\Models\Order::where('customer_id',$user->id)->get();
               @endphp
                <a href="{{url('/orders')}}" style="width: 100%; " class="nav-item nav-link active">My Orders {{$order->count()}}</a>
                
                <a href="/order" class="nav-item nav-link btn-primary px-5 " style=" margin:5px ; color:aliceblue; text-transform: capitalize;  ">OrderNow</a>
            
            </div>
                <nav style="width: 150px; margin-left: 20px" class="navbar  navbar-expand-sm">
